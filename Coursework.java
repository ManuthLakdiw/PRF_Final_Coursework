...
public class Coursework {
	...
	public static void addItem() {
		// System.out.println(Arrays.deepToString(itemArray)); // athule thiyena values
		// balnawa
		if (category.length == 0) {
			System.out.print(
					"OOOOOOPS! It seems that you dan't have any item categories in the System.\nDo you want to add a new item category (y/n) > ");
			...
			System.out.print(
					"OOOOOOPS! It seems that you dan't have any item suppliers in the System.\nDo you want to add a new supplier (y/n) > ");
			String yOrn = scanner.next();
			if (yOrn.equalsIgnoreCase("y")) {
				clearConsole();
				System.out.println(
				...
				for (int j = 0; j < itemArray.length; j++) {
					if (itemArray[j][1].equals(option)) {
						System.out.printf("| %-19s | %-19s | %-19s | %-19s | %-19s |\n", itemArray[j][0],
								itemArray[j][3], itemArray[j][4], itemArray[j][5], itemArray[j][2]);
					}
				}
				System.out.println(
						"+---------------------+---------------------+---------------------+---------------------+---------------------+");
		...
		for (int i = 0; i < category.length; i++) {
			...
			for (int k = 0; k < itemArray.length; k++) {
				if (itemArray[k][2].equals(category[i])) {
					System.out.printf("| %-19s | %-19s | %-19s | %-19s | %-19s |\n", itemArray[k][1], itemArray[k][0],
							itemArray[k][3], itemArray[k][4], itemArray[k][5]);
					System.out.println(
							"+---------------------+---------------------+---------------------+---------------------+---------------------+");
				}
			}
